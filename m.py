...
bot = telebot.TeleBot('7208793858:AAGggXSul147bdwUpRocC0mc-BraYrkep2E')
...
✅ Usage: /remove <userid>😘'''
        ...
        response = "BHAI AAP ADMIN NHI HO 🤣 😡."
...
def clear_logs_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "BROTHER BOLA NA AAP ADMIN NHI HO🤣 😡."
    bot.reply_to(message, response)
    ...
    if user_id in allowed_user_ids:
        ...
        if user_id not in admin_id:
            ...
            if user_id in bgmi_cooldown and (datetime.datetime.now() - bgmi_cooldown[user_id]).seconds < 10:
                response = " Please Wait 10sec Before Running The /bgmi Command Again."
                bot.reply_to(message, response)
                return
...
3. MAKE SURE OTHERWISE NOT WORK
